...
class Create_Post {
	...
	public function handle_doc_creation() {
		...
		if ( isset( $_GET['Create_Section'], $_GET['parentID'], $_GET['_wpnonce'], $_GET['is_section'] ) && 
			 ...
			 wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'ezd_create_section_nonce_' . absint( wp_unslash( $_GET['parentID'] ) ) ) ) {
		...
		if ( isset( $_GET['Create_Child'], $_GET['childID'], $_GET['_wpnonce'], $_GET['child'] ) && 
			 ...
			 wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'ezd_create_child_nonce_' . absint( wp_unslash( $_GET['childID'] ) ) ) ) {
