        ...
        if ( $settings['is_custom_order'] == 'yes' && !empty($settings['docs']) ) {
            ...
            if ( $parent_docs ) :
                foreach ($parent_docs as $i => $doc) :
                    ...
                    ?>
                    <li class="nav-item">
                        <a <?php echo $href.$aria_controls; ?> id="doc2-<?php echo $doc->post_name; ?>-tab" class="nav-link <?php echo esc_attr($active) ?>" data-bs-toggle="tab">
                            <?php
                            if ( $settings['is_tab_title_first_word'] == 'yes' ) {
                                echo wp_kses_post($doc_name[0]);
                            } else {
                                    ...
                                    <div class="media documentation_item">
                                        ...
                                        <div class="media-body">
                                            <a href="<?php echo get_permalink($section->ID); ?>">
                                                <h5 class="title"> <?php echo wp_kses_post($section->post_title); ?> </h5>
                                            </a>
                                            <p>
                                                <?php
