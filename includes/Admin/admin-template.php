	...
	<?php
		if ( $docs_num > 0 ) :
            ...
            <div class="eazydocs-no-content">
                ...
                <p> <br>
                <a class="button button-primary ezd-btn btn-lg" href="<?php echo esc_url( admin_url( 'admin.php' ) . '?Create_doc=yes&_wpnonce=' . wp_create_nonce( 'create_new_doc_nonce' ) . '&new_doc=' ); ?>" id="new-doc">
