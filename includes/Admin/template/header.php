        ...
        <div class="row alignment-center justify-content-between ml-0">
            <div class="navbar-left d-flex alignment-center">
                ...
                if ( current_user_can( 'edit_posts' ) ) :
                    ?>
                    <button type="button" data-url="<?php echo esc_url(admin_url('admin.php')); ?>?Create_doc=yes&_wpnonce=<?php echo wp_create_nonce('parent_doc_nonce'); ?>&parent_title=" id="parent-doc" class="easydocs-btn easydocs-btn-outline-blue easydocs-btn-sm easydocs-btn-round">
                    ...
                    <li>
                        <div class="easydocs-settings">
                            ...
                            <div class="header-notify-icon ezd-trashicon" title="<?php esc_attr_e( 'View, manage, restore the trashed docs', 'eazydocs' ) ?>">
                                <a href="<?php echo esc_url(admin_url('edit.php?post_status=trash&post_type=docs')); ?>">
