...
class Assets {
	...
	public static function enqueue_scripts() {
		...
		wp_register_script( 'bootstrap-select', 'https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta2/dist/js/bootstrap-select.min.js',
			array( 'bootstrap' ), '1.14.0', true );
