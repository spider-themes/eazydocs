<?php
/**
 * Flat Tabbed preset template for Tabbed Docs block
 * A simpler, flatter design variant with ezd- prefixed classes
...
$block_unique_id = wp_unique_id( 'ezd-flat-tabbed-' );
