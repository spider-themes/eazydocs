...
{
	// Only show this notice on EazyDocs Dashboard and Docs Builder pages
	if (!ezd_admin_pages(['eazydocs', 'eazydocs-builder'])) {
		return;
	}
	...
	?>
	<div class="notice notice-info is-dismissible" id="ezd_gutenberg_info"
		...
		<div style="display: flex; align-items: start;">
			...
			<div style="padding-top: 2px;">
				...
				<div style="margin-top: 12px;">
					<a href="https://helpdesk.spider-themes.net/docs/eazydocs-wordpress-plugin/gutenberg-blocks/"
						target="_blank"
						style="color: #2271b1; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 4px;">
