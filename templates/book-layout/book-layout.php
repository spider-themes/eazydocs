...
$doc_container   = $doc_width == 'full-width' ? 'container-fluid pl-60 pr-60 doc-book-layout' : 'container custom_container doc-book-layout';
            ...
            <div class="row">
				...
				while ( have_posts() ) : the_post();
					if ( ! empty( $layout == 'left_sidebar' ) || ! empty( $layout == 'both_sidebar' ) ) {
						eazydocs_get_template_part( 'book-layout/docs-sidebar' );
					}
					?>
                    <div class="<?php echo esc_attr( $md_content_col ); ?> doc-middle-content">
						<?php eazydocs_get_template_part( 'book-layout/single-doc-content' ); ?>
                    </div>
					<?php
