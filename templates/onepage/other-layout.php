...
?>
<section class="documentation_area_sticky doc_documentation_area onepage_doc_area page_wrapper" id="sticky_doc">
            ...
            <div class="row doc-container">
                <div class="col-xl-3 col-lg-3 doc_mobile_menu doc-sidebar sticky-top left-column">
                    <aside class=" one-page-docs-sidebar-wrap">
						...
						?>
                        <div class="docs-twice-btn-wrapper">
                            <a href="#">SEE OUR PORTFOLION</a>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 doc_right_mobile_menu sticky-top">
