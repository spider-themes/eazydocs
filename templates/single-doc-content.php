...
<div class="left-sidebar-toggle">
    <span class="left-arrow arrow_triangle-left" title="<?php esc_attr_e( 'Hide category', 'eazydocs' ); ?>"
        style="display: block;"></span>
    <span class="right-arrow arrow_triangle-right" title="<?php esc_attr_e( 'Show category', 'eazydocs' ); ?>"
                    ...
                    <span class="ezdoc_contributed_user_avatar">
                        <span class="contributed_user_list">
                            ...
                            <a href="<?php echo get_author_posts_url($ezd_doc_contributor); ?>"
                                title="<?php echo $available_user->display_name ?? ''; ?>" data-bs-toggle="tooltip"
                            ...
                            <div class="ezdoc_contributed_users">
                                ...
                                <div class="doc_users_dropdown ezd-shadow-lg">
                                    ...
                                    <form action="#" method="POST">
                                        <input type="text" name="ezd_contributor_search" id="ezd-contributor-search"
                                            placeholder="<?php esc_attr_e( 'Search By Email or Name', 'eazydocs' ); ?>">
                                    </form>
                                    <?php
                                            endif;
                                            ?>
                                    ...
                                    <div class="doc_dropdown_users_list" id="added_contributors">
                                        <?php
                                                ...
                                                ?>
                                        <ul class="users_wrap_item <?php echo esc_attr('user-'.$current_doc_author); ?>"
                                            id="<?php echo esc_attr('user-'.$current_doc_author); ?>">
                                            <li>
                                        ...
                                        <ul class="users_wrap_item <?php echo esc_attr('user-'.$ezd_doc_contributor); ?>"
                                            ...
                                            <li>
                                                <a data_name="<?php echo $available_user->display_name ?? ''; ?>"
                                                    class="test circle-btn ezd_contribute_delete"
                                                    data-contributor-delete="<?php echo esc_attr($ezd_doc_contributor); ?>"
                                    ...
                                    <div class="doc_dropdown_users_list" id="to_add_contributors" data-page="1">
                                        ...
                                        <ul class="users_wrap_item <?php echo esc_attr('to-add-user-'.$add_contributor->ID); ?>"
                                            ...
                                            <li>
                                                <a data_name="<?php echo get_the_author_meta( 'display_name', $add_contributor->ID ); ?>"
                                                    href='<?php echo get_author_posts_url($add_contributor->ID); ?>'>
                                            ...
                                            <li>
                                                <a data_name="<?php echo get_the_author_meta( 'display_name', $add_contributor->ID ); ?>"
                                                    class="circle-btn ezd_contribute_add"
                                                    data-contributor-add="<?php echo esc_attr($add_contributor->ID); ?>"
                                                    data-doc-id="<?php echo esc_attr(get_the_ID()); ?>">
                                                    &plus;
                                                </a>
                                            </li>
...
(function($) {
    $(document).ready(function() {
        ...
        var canBeLoaded = true, // this param allows to initiate the AJAX call only if necessary
            bottomOffset =
            2000; // the distance (in px) from the page bottom when you want to load more posts
