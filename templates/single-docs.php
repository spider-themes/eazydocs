...
$credit_enable      = $opt['eazydocs-enable-credit'] ?? '1';
$credit_text        = $opt['eazydocs-credit-text'] ?? sprintf(__("%s", 'eazydocs'), 'Powered By <a href="https://wordpress.org/plugins/eazydocs/" target="_blank">EazyDocs</a>');
$breadcrumb         = $opt['docs-breadcrumb'] ?? '1';
